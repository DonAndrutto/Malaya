...
// topic keeps serving stale listings until the 24-hour safety-net TTL runs
// out. This ping is the publish step, not an optimisation on top of it.
// Debouncing, auth and fire-and-forget semantics live in lib/revalidate-ping.
function scheduleStorefrontRevalidate() {
  pingRevalidate('explore');
}
