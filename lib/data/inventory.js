...
// "Gold" covers every gold-toned material so the studio can adjust all gold
// pieces at once (e.g. when the gold spot price moves); silver and platinum
// stand alone.
export const METAL_GROUPS = {
  Gold: ['18k Gold', '14k Gold', 'White Gold', 'Rose Gold', 'Vermeil', 'Gold Plated'],
  Silver: ['Silver'],
  Platinum: ['Platinum'],
};
