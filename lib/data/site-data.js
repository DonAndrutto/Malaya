...
export const siteImg = (f) => SITE_BASE + 'images/' + f;
export const prodImg = (f) => SITE_BASE + 'products/' + f;
...
export function buildSiteData(overrides = {}) {
  ...
  const SITE_PRODUCTS = [...catalogue, ...SITE_EXTRAS];
...
export const SITE_NAV = [
  { label: 'Home', hash: '#/' },
  { label: 'Catalogue', hash: '#/catalogue', mega: true },
  { label: 'Tashi Mannox', hash: '#/tashi' },
