...
import { resolveCatalogue, resolveProduct } from './resolve';
...
export function buildSiteData(overrides = {}) {
  ...
  // Live-site extras are now first-class, fully override-aware products (name,
  // price, category, images, story … all editable from the admin).
  const extras = SITE_EXTRAS
    .map((p) => ({ ...resolveProduct(p, overrides[p.id]), tashi: p.tashi }))
    .filter((p) => !HIDDEN_STOCK.includes(p.stock));

  // Drop any item merged into another so each physical piece shows once; the
  // master listing carries it.
  const SITE_PRODUCTS = [...ledgerProducts, ...catalogue, ...extras].filter((p) => !isMerged(p.id));
...
const DEFAULT_WA_TEXT = 'Hi, I contacted you Through Malaya Bhutan website.';
...
export const CONTENT_DEFAULTS = {
  nav: { home: 'Home', catalogue: 'Catalogue', tashi: 'Tashi Mannox', contact: 'Contact', about: 'About', instagram: 'Instagram' },
  hero: { title: 'Malaya Jewelry', subtitle: 'Bhutan', cta: 'View All Collections' },
  home: {
    sectionTitle: 'Malaya Jewelry', bannerTitle: 'Malaya Jewelry — Order Now', bannerCta: 'View All Collections',
    tiles: { Rings: 'Malaya Rings', Bracelets: 'Bracelets', Earrings: 'Earrings', Pendants: 'Pendants' },
  },
  banners: {
    catalogueSubtitle: 'Malaya Jewelry',
    about: { title: 'About', subtitle: 'Malaya Jewelry' },
    contact: { title: 'Contact', subtitle: 'Malaya Jewelry' },
    order: { title: 'My Order', subtitle: 'Malaya Jewelry' },
    tashi: { title: 'Collaboration', subtitle: 'With Malaya Jewelry' },
  },
  about: {
    date: 'Oct 23, 2016', title: 'Malaya Jewelry Bhutan', lead: ABOUT_LEAD,
    from: 'A letter from: The Shop Team at Malaya Jewelry in Bhutan',
    caption: 'Malaya Jewelry — inspired by traditional Bhutanese and Buddhist iconography', body: ABOUT_BODY,
  },
  tashi: {
    kicker: 'Malaya Jewelry Collaboration With', name: 'Tashi Mannox', role: 'Calligraphy Artist',
    intro: TASHI_INTRO, productsTitle: 'Tashi Mannox & Malaya Jewelry',
  },
  mega: { promoTitle: 'Mystical Beings', promoDesc: 'Add a splash of colour to your Jewelry with Malaya.', promoCta: 'Order Now' },
  footer: {
    contactStrip: 'Questions about Malaya Jewelry?', followNote: 'Get latest news and proposals',
    copyright: '© 2018–2026 Malaya Jewelry', location: 'Thimphu, Bhutan',
  },
  contact: {
  ...
  legal: {
    privacy: {
      ...
      body: [
        'Malaya Jewelry respects your privacy. We only collect the information you choose to share with us — such as your name, email address and the details you send when you contact us or place an order — and we use it solely to respond to your enquiry and fulfil your order.',
    ...
    terms: {
      ...
      body: [
        'By using this website and placing an order with Malaya Jewelry you agree to these terms. All orders are subject to availability and confirmation of the price; we confirm availability, shipping and payment with you directly over WhatsApp or email before any order is finalised.',
        'All designs, images and content on this site remain the property of Malaya Jewelry and may not be reproduced without our written permission.',
      ],
    },
    cookie: {
      title: 'Cookie Policy',
    ...
    refund: {
      title: 'Refund Policy',
      body: [
        'Every Malaya Jewelry piece is crafted with great care. If something is not right with your order, please contact us within 14 days of receiving it and we will work with you to arrange a repair, exchange or refund where appropriate.',
