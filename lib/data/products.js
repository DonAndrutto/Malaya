...
const IMG = 'https://malayajewelrybhutan.com/products/';
...
export const MATERIALS = [
  '18k Gold', '14k Gold', 'White Gold', 'Rose Gold', 'Vermeil',
  'Silver', 'Gold Plated', 'Platinum',
];
export const STOCK_OPTIONS = ['In stock', 'Low stock', 'Made to order', 'Sold out', 'Archived'];
...
function pick(sub) {
  ...
  if (s.includes('gold plated') || s.includes('gold-plated')) return 'Gold Plated';
  if (s.includes('18k') || s.includes('18 k') || s.includes('18 yellow')) return '18k Gold';
  if (s.includes('14k') || s.includes('14 k')) return '14k Gold';
