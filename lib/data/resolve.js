...
import { normalizeRingSizes } from './ring-sizes';
...
export function resolveProduct(base, override) {
  ...
  return {
    ...
    // Ring-size inventory (Rings only): EU size → units on hand within this
    // SKU (lib/data/ring-sizes.js). Null for everything else.
