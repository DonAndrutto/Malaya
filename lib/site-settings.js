...
// a slot is unset):
//   heroCollections: { [collection]: { img, order, cta, enabled } }
//                            collection-based home hero slides (one per
//                            catalogue collection; see resolveHeroSlides)
//   heroSlides:  string[]   legacy plain home hero slideshow — the fallback
//                           while no collection slide is enabled
